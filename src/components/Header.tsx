    ...
    return (
        <header className="bg-red-500 py-4 h-[54px] flex items-center px-2 fixed w-full z-50 top-0 lg:px-5 lg:h-[60px] xl:px-10 lg:justify-start">
            <div className="lg:hidden">
                ...
                <nav className={`fixed top-[54px] left-0 w-4/5 h-full bg-red-100 py-4 transform transition-transform duration-300 ease-in-out z-20 ${isOpen ? "translate-x-0" : "-translate-x-full"} `}>
